...
// if position at the end, call append
...
void ilInsertSorted (IntList *il, int val)
{
  ...
  //// loop thru to find position "n" where pos n-1 < val & pos n+1 > val
  //// move every element from position n right one
  //// insert val into position n
